...
def wishme():
    ...
    if hour > 0 and hour < 12:
        ...
        speak("Good Evening")
    speak("i am arun sir. please tell me how can i help you")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if "open notepad" in query:
            ...
            cur = con.cursor()
            name = takeCommand().lower()
            speak("kindly tell your age")
            sk = takeCommand().lower()
            speak("kindly tell your email_id")
            email = takeCommand().lower()
            speak("kindly tell your Train-id")
            br = takeCommand().lower()
            speak("kindly tell your contact-number")
            p_l = takeCommand().lower()
            speak("kindly tell your date")
            d = takeCommand().lower()
            ...
            try:
                ...
                my_pdf.cell(200, 10, txt="Passenger details", ln=1, align="C")
                ...
                speak("ticket is booked succesfully")
                '''
